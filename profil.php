<!DOCTYPE html>
    <html lang="fr">
        <head>
            ...
            <link href="profil.css" rel="stylesheet"> <!-- A VOIR SI JE GARDE -->
        ...
        <body>
           ...
           <h3> A PROPOS DE MOI </h3>
                <p>Je m’appelle Yohan Fresneau, je suis âgé de 20 ans. Je suis actuellement étudiant à Tours au lycée Paul Louis Courier, 
                    en deuxième année de BTS « SIO spécialité SISR » Services Informatiques aux Organisations spécialité en Solutions 
                    d'Infrastructure, Systèmes et Réseaux. Depuis mes jeunes années, j’ai toujours été attiré par l’informatique et 
                    les nouvelles technologies. C’est tout naturellement que je me suis tourné vers ces études, en effectuant mes trois 
                    années d’études en BAC PRO « Système Electronique et Numérique », et mes deux années d’études en BTS Services Informatiques 
                    aux Organisations spécialité en Solutions d'Infrastructure, Systèmes et Réseaux.
                </p>
            <h3> EXPERIENCES PROFESSIONNELLES</h3>
                <p> J’ai eu l'opportunité d’effectuer des stages en milieu professionnel, dans différentes entreprises, disposant d’un service informatique. 
            ...
            <h3> PROJET PROFESSIONNEL </h3>
                <p>Mon projet professionnel aujourd’hui est de devenir « Responsable en Ingénierie Systèmes et Réseaux ». 
                    A partir du 24 septembre, j’intègre l’école supérieure des métiers CESI du Mans pour suivre durant 2 ans, 
                    une formation diplômante bac+4 afin de devenir « Responsable en Ingénierie Systèmes et Réseaux ». Je souhaite 
                    par le biais de l’apprentissage en l’alternance participer à la construction et au développement de l’entreprise, 
                    en grandissant avec elle, en apportant mes compétences, ma motivation et en partageant ma passion de la haute technologie.
                     En participant à la mise en œuvre et l’exploitation des réseaux informatiques, téléphonique. En contribuant au bon 
                     fonctionnement des réseaux et en intervenant sur les incidents en les dépannant. En participant à la gestion 
                     et à l'administration des réseaux.
                </p>
            <h3> MES QUALITES </h3>
                <!-- a faire plus tard mettre des animations -->
                <br><br><br><br><br>
                ...
                <div class="solution_cards_box">
                    <div class="solution_card">
                        ...
                        <div class="solu_description">
                            <p>
                                La réactivité permet une résolution rapide des problémes                            
                            </p>
                        </div>
                    </div>
                </div>
