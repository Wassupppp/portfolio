  ...
  <body>
    ...
    <main role="main">
      ...
      <div id="presentation" class="album py-5 bg-light">
        <div class="container">
          <div class="col-md-12">
              <h1 class="py-5 my-5 text-center"><span>Glossaire</span></h1>
              <h2 class="mt-5">PCA - PCO - PCI - PGC - PRA</h2>
              <img src="images/si7.PNG" class="rounded mx-auto d-block" alt="...">
              <h2 class="mt-5">Git vs SVN</h2>
              <img src="images/git-centralized-vs-distributed.png" class="rounded mx-auto d-block" alt="...">
              <h2 class="mt-5">Réglement Général sur la Protection des Données (RGPD)</h2>
              <img src="images/rgpd_4_etapes.jpg" class="rounded mx-auto d-block" alt="...">
          </div>
