<!DOCTYPE html>
    <html lang="fr">
        <head>
            ...
            <link href="bts.css" rel="stylesheet"> <!-- A VOIR SI JE GARDE -->
                ...
                <div class="container px-4">
                    <div class="row gx-5">
                        ...
                        <div class="col" style='margin-bottom:10%;'>
                            <h4 class="p-3 border bg-light text-center overline" >SIO SISR</h4>
